...
import PaymentFailDetailDialog from '@pages/Point/Dialog/PaymentFailDetailDialog'
import FileDeleteConfirmDialog from '@pages/Point/Dialog/FileDeleteConfirmDialog'
...
function PointDataGrid() {
  ...
  const { data, isLoading, refetch } = useQueryWrap<PointListRes>(
    ['pointList', params],
    () =>
      NetworkService.commerce.get<PointListReq>(
        COMMERCE_POINT_API_PATH.POINT_LIST,
        params
      )
  )
