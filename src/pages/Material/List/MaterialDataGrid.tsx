...
import { MaterialDto, materialListRes } from '@api/model/MDM/material'
...
import { MaterialQueryKey } from '@pages/Material/Props'
  ...
  const { data, isLoading, refetch } = useQueryWrap<materialListRes>(
    ...
    () =>
      NetworkService.mdm.get(
        MDM_MATERIAL_API_PATH.MATERIAL_LIST,
        searchCondition
      )
  )
      ...
      renderCell: (params) => {
        return (
          <Link
            ...
            data-sb-kind={'pages/MDM/Material/ProductDetail'}
            target="_blank"
            color="primary"
            underline={'hover'}
          >
