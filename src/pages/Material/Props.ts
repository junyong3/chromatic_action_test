export const MaterialQueryKey: {
  [key: string]: any
} = {
  materialList: ['MaterialList'] as const,
  materialDetail: ['MaterialDetail'] as const,
}

export interface MaterialInfoTS {
  // 자재코드, 자재명, 군, ph1, ph2
  materialCode: string
  materialName: string
  group: string
