...
const Template: Story<DataGridProps> = (args: DataGridProps) => {
  ...
  return (
    <DataGridWrap>
      <DataGrid
        {...args}
        onColumnVisibilityModelChange={action('onColumnVisibilityModelChange')}
        rows={dataSet}
        columns={columns}
      />
    </DataGridWrap>
...
export const ColumnVisibilityModelChange = Template.bind({})

ColumnVisibilityModelChange.args = {
