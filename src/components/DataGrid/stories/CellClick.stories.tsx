...
const Template: Story<DataGridProps> = (args: DataGridProps) => {
  ...
  /*
   * (params: GridCellParams, event: MuiEvent<React.MouseEvent>, details: GridCallbackDetails) => void
   * */
  return (
    <DataGridWrap>
      <DataGrid
...
export default {
  title: 'components/MUI/DataGrid/Event/CellClick',
  component: DataGrid,
...
export const CellClick = Template.bind({})
