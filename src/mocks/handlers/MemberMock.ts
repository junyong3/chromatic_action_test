...
import { COMMERCE_MEMBER_API_PATH as API } from '@src/api/path/Commerce/memberPath'
import {
  MemberStatus,
  OrderCheck,
...
const ROOT_PATH = API_ROOT_PATH.COMMERCE_MEMBER

export const MemberMock = {
  MemberList: rest.get(`${ROOT_PATH}${API.MEMBER_LIST}`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({
        success: true,
  ...
  MemberDetail: rest.get(
    `${ROOT_PATH}${API.MEMBER_DETAIL(':id')}`,
    (req, res, ctx) =>
      res(
        ctx.status(200),
        ctx.json({
  ...
  VerifyPhone: rest.post(
    `${ROOT_PATH}${API.VALIDATE_PHONE}`,
    (req, res, ctx) => {
      const successJSON = {
        success: true,
        code: 'SUCCESS',
  ...
  VerifyEmail: rest.post(`${ROOT_PATH}${API.VALIDATE_EMAIL}`, (req, res, ctx) =>
    res(
      ctx.status(200),
      ctx.json({
        success: true,
  ...
  UpdateMember: rest.patch(
    `${ROOT_PATH}${API.UPDATE_MEMBER(':id')}`,
    (req, res, ctx) =>
      res(
        ctx.status(200),
        ctx.json({
  ...
  CSCouponList: rest.get(
    `${ROOT_PATH}${API.CS_COUPON_LIST}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  MemberCouponList: rest.get(
    `${ROOT_PATH}${API.MEMBER_COUPON(':id')}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  MemberPointHistoryList: rest.get(
    `${ROOT_PATH}${API.MEMBER_POINT_HISTORY(':id')}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  UseMemberPoint: rest.patch(
    `${ROOT_PATH}${API.MEMBER_POINT(':id')}`,
    (req, res, ctx) =>
      res(
        ctx.status(200),
        ctx.json({
  ...
  MemberRefundAccountInfo: rest.get(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.REFUND_ACCOUNT}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  SaveMemberRefundAccount: rest.patch(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.SAVE_REFUND_ACCOUNT}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
  ...
  RemoveMemberRefundAccount: rest.patch(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.REMOVE_REFUND_ACCOUNT}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({ code: 'SUCCESS', message: '성공', data: true })
  ...
  RefundAccountBankList: rest.get(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.REFUND_ACCOUNT_BANK_LIST}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  AddMemberCreditCard: rest.post(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.MEMBER_CREDIT_CARD}`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
  ...
  DeleteMemberCreditCard: rest.delete(
    `${API_ROOT_PATH.COMMERCE_PAYMENT}${COMMERCE_PAYMENT_API_PATH.MEMBER_CREDIT_CARD}/:memberId`,
    (req, res, ctx) => {
      return res(
        ctx.status(200),
        ctx.json({
