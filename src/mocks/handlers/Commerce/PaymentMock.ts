...
export const PaymentMock = {
  PaymentList: rest.get(CommerceMockPath.PaymentList, (req, res, ctx) => {
  ...
  PaymentHistory: rest.get(CommerceMockPath.PaymentHistory, (req, res, ctx) => {
    // const params = req.url.searchParams.getAll('limit')
    return res(
      ctx.status(200),
      ctx.json({
  ...
  UpdatePayment: rest.patch(CommerceMockPath.UpdatePayment, (req, res, ctx) => {
