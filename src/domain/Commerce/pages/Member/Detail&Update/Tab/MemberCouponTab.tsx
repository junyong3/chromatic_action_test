...
import { MemberTabProps } from '@domain/Commerce/pages/Member/Detail&Update/Tab/Props'
import { CSCouponListRes } from '@api/model/Commerce/member'
...
function MemberCouponTab({ memberId }: MemberTabProps) {
  ...
  const { data, refetch } = useQueryWrap<CSCouponListRes>(
    ...
    () => Instance.get(COMMERCE_MEMBER_API_PATH.CS_COUPON_LIST)
  )
  useEffect(() => {
